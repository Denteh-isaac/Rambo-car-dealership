		...
		<>
			<div className="card-flight card-hotel card-property background-card border">
				<div className="card-image">
					<Link href="/cars-details-3"><img src={`/assets/imgs/cars-listing/cars-listing-6/${car.image}`} alt="Gastonsin" /></Link>
				</div>
					...
					<div className="card-program">
						...
						<div className="endtime">
							<div className="card-price">
								...
								<h6 className="heading-6 neutral-1000"><Price amount={car?.price ?? 778.35} /></h6>
