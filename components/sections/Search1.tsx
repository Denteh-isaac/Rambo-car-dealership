					...
					<div className="box-search-advance background-card wow fadeIn">
						<div className="box-top-search">
							<div className="left-top-search">
								<Link className="category-link text-sm-bold btn-click active" href="/cars-list-1">All cars</Link>
								<Link className="category-link text-sm-bold btn-click" href="/cars-list-1?listing=sale">For sale</Link>
								<Link className="category-link text-sm-bold btn-click" href="/cars-list-1?listing=rental">For rent</Link>
							</div>
