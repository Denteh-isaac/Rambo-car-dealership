...
const testimonials = [
    {
        ...
        text: "Gastonsin made importing my Toyota Land Cruiser from Dubai so easy. They handled all the paperwork, clearing, and delivery to Esiama. I couldn't be happier!",
        name: "Kofi Mensah",
        location: "Esiama, W/R",
    ...
    },
    {
        ...
        text: "I pre-ordered a Jetour X70 from China through Gastonsin and it arrived exactly as described. No hidden charges, no surprises. Very professional team.",
        name: "Ama Asante",
        location: "Takoradi",
    ...
    },
    {
        ...
        text: "Rented a car for my business trip to Accra. Gastonsin's rental fleet is clean, well-maintained, and the booking process is straightforward. Highly recommend!",
        name: "Kwame Boateng",
        location: "Esiama",
    ...
    },
    {
        ...
        text: "Gastonsin cleared my Changan from the port in record time. The logistics team kept me updated at every step. Excellent service all the way.",
        name: "Abena Owusu",
        location: "Kikam",
    ...
    },
    {
        ...
        text: "I was nervous about ordering a car from the US but Gastonsin walked me through everything. My Ford arrived in perfect condition. 5 stars without hesitation!",
        name: "Yaw Darko",
        location: "Kumasi",
    ...
    },
    {
        ...
        text: "My whole family has bought cars through Gastonsin. My father, my uncle, and now me. They treat every customer like family. The prices are fair and quality is top.",
    ...
    },
    {
        ...
        text: "From browsing the inventory online to picking up the car at the Esiama warehouse — the whole journey with Gastonsin was smooth and professional.",
        name: "Nana Barimah",
        location: "Accra",
    ...
    },
    {
        ...
        text: "Finally got my Changan CS55 Plus! Gastonsin sourced it directly from China. The car is immaculate and exactly what I ordered. Will definitely come back.",
        name: "Esi Tetteh",
        location: "Tema",
                ...
                <div className="container">
                    <div className="row align-items-end">
                        <div className="col-md-9 col-sm-9 wow fadeInUp">
                            ...
                            <h3 className="mt-8 mb-15 neutral-1000">What our customers say about Gastonsin</h3>
                        </div>
                    </div>
                </div>
