				...
				<div className="container">
					...
					<div className="row">
							...
							<div className="mt-20 mb-20">
								<Link className="d-flex align-items-center" href="/">
									<span style={{display: 'flex', flexDirection: 'column', lineHeight: 1.1}}>
										<span style={{fontWeight: 900, fontSize: '1.6rem', color: '#70f46d', letterSpacing: '-0.5px', textTransform: 'uppercase'}}>Rambo</span>
										<span style={{fontWeight: 500, fontSize: '0.55rem', color: 'rgba(255,255,255,0.75)', letterSpacing: '2px', textTransform: 'uppercase'}}>Car Dealership &amp; Rentals</span>
									</span>
								</Link>
								<div className="box-info-contact mt-0">
									<p className="text-md neutral-400 icon-address">Nzema, Western Region, Ghana</p>
									<p className="text-md neutral-400 icon-worktime">Hours: 8:00 - 18:00, Mon - Sat</p>
									<p className="text-md neutral-400 icon-email">info@rambocardealership.com</p>
								</div>
						...
						<div className="col-md-2 col-xs-6 footer-2">
							...
							<ul className="menu-footer">
								<li><Link href="#">Car Importation &amp; Shipping</Link></li>
								<li><Link href="#">Vehicle Sales (Ghana Stock)</Link></li>
								<li><Link href="#">Car Rentals</Link></li>
								<li><Link href="#">Pre-Order from China / USA / Dubai</Link></li>
								<li><Link href="#">Warehouse Pickup in Ghana</Link></li>
								<li><Link href="#">Fleet &amp; Corporate Solutions</Link></li>
								<li><Link href="#">Port Clearing &amp; Logistics</Link></li>
							</ul>
						</div>
					...
					<div className="footer-bottom mt-50">
						<div className="row align-items-center justify-content-center">
							<div className="col-md-6 text-md-start text-center mb-20">
								<p className="text-sm color-white">© {new Date().getFullYear()} Rambo Car Dealership &amp; Rentals. All rights reserved.</p>
							</div>
