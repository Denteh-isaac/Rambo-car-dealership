				...
				<div className="top-bar top-bar-2 top-bar-3 bg-transparent">
					<div className="container-fluid">
						<div className="text-header-info">
							<Link className="phone-head text-white" href="tel:+2332411456455">
						...
						<div className="text-header">
							<div className="text-unlock text-sm-medium text-white">Premium imported cars from <span className="text-primary">China, USA &amp; Dubai</span> — Shipped to Ghana</div>
