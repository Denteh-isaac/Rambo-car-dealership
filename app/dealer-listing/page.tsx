					...
					<div className="page-header pt-30 background-body">
						<div className="custom-container position-relative mx-auto">
							<div className="bg-overlay rounded-12 overflow-hidden">
								<img className="w-100 h-100 img-banner" src="/assets/imgs/page-header/banner7.png" alt="Gastonsin" />
							</div>
							...
							<div className="background-body position-absolute z-1 top-100 start-50 translate-middle px-3 py-2 rounded-12 border d-flex gap-3 d-none">
								...
								<Link href="/dealer-listing" className="neutral-1000 text-md-bold">Dealer Listing</Link>
							</div>
						</div>
					</div>
					{/* dealer listing */}
							...
							<div className="row mt-60">
									...
									<div className="card-contact card-dealer d-flex">
										<div className="card-image me-3">
											<div className="position-relative">
												<img src="/assets/imgs/dealer/dealer-listing/icon-1.svg" alt="Gastonsin" />
											</div>
										</div>
										<div className="card-info">
											<div className="card-title">
												<Link className="title heading-6" href="/dealer-details">Gastonsin Takoradi</Link>
												<p className="text-md-medium neutral-500">Esiama off Nkroful Road, Western Region</p>
											</div>
								...
								<div className="col-lg-4 col-sm-6">
									<div className="card-contact card-dealer d-flex">
										<div className="card-image me-3">
											<div className="position-relative">
												<img src="/assets/imgs/dealer/dealer-listing/icon-2.svg" alt="Gastonsin" />
											</div>
										</div>
										<div className="card-info">
											<div className="card-title">
												<Link className="title heading-6" href="/dealer-details">Gastonsin Kumasi</Link>
												<p className="text-md-medium neutral-500">8 Harbour Road, Takoradi, Western Region</p>
											</div>
											<div className="card-method-contact2">
												<Link className="email text-xs-bold" href="/cars-list-1">
													180 Vehicles
								...
								<div className="col-lg-4 col-sm-6">
									<div className="card-contact card-dealer d-flex">
										<div className="card-image me-3">
											<div className="position-relative">
												<img src="/assets/imgs/dealer/dealer-listing/icon-3.svg" alt="Gastonsin" />
											</div>
										</div>
										<div className="card-info">
											<div className="card-title">
												<Link className="title heading-6" href="/dealer-details">Gastonsin Accra</Link>
												<p className="text-md-medium neutral-500">14 Liberation Road, Airport Residential, Accra</p>
											</div>
											<div className="card-method-contact2">
												<Link className="email text-xs-bold" href="/cars-list-1">
													180 Vehicles
								...
								<div className="col-lg-4 col-sm-6">
									<div className="card-contact card-dealer d-flex">
										<div className="card-image me-3">
											<div className="position-relative">
												<img src="/assets/imgs/dealer/dealer-listing/icon-4.svg" alt="Gastonsin" />
											</div>
										</div>
										<div className="card-info">
											<div className="card-title">
								...
								<div className="col-lg-4 col-sm-6">
									<div className="card-contact card-dealer d-flex">
										<div className="card-image me-3">
											<div className="position-relative">
												<img src="/assets/imgs/dealer/dealer-listing/icon-5.svg" alt="Gastonsin" />
											</div>
										</div>
										<div className="card-info">
											<div className="card-title">
								...
								<div className="col-lg-4 col-sm-6">
									<div className="card-contact card-dealer d-flex">
										<div className="card-image me-3">
											<div className="position-relative">
												<img src="/assets/imgs/dealer/dealer-listing/icon-6.svg" alt="Gastonsin" />
											</div>
										</div>
										<div className="card-info">
											<div className="card-title">
								...
								<div className="col-lg-4 col-sm-6">
									<div className="card-contact card-dealer d-flex">
										<div className="card-image me-3">
											<div className="position-relative">
												<img src="/assets/imgs/dealer/dealer-listing/icon-7.svg" alt="Gastonsin" />
											</div>
										</div>
										<div className="card-info">
											<div className="card-title">
								...
								<div className="col-lg-4 col-sm-6">
									<div className="card-contact card-dealer d-flex">
										<div className="card-image me-3">
											<div className="position-relative">
												<img src="/assets/imgs/dealer/dealer-listing/icon-8.svg" alt="Gastonsin" />
											</div>
										</div>
										<div className="card-info">
											<div className="card-title">
								...
								<div className="col-lg-4 col-sm-6">
									<div className="card-contact card-dealer d-flex">
										...
										<div className="card-info">
											<div className="card-title">
												<Link className="title heading-6" href="/dealer-details">Gastonsin Esiama</Link>
								...
								<div className="col-lg-4 col-sm-6">
									<div className="card-contact card-dealer d-flex">
										<div className="card-image me-3">
											<div className="position-relative">
												<img src="/assets/imgs/dealer/dealer-listing/icon-10.svg" alt="Gastonsin" />
											</div>
										</div>
										<div className="card-info">
											<div className="card-title">
								...
								<div className="col-lg-4 col-sm-6">
									<div className="card-contact card-dealer d-flex">
										<div className="card-image me-3">
											<div className="position-relative">
												<img src="/assets/imgs/dealer/dealer-listing/icon-11.svg" alt="Gastonsin" />
											</div>
										</div>
										<div className="card-info">
											<div className="card-title">
								...
								<div className="col-lg-4 col-sm-6">
									<div className="card-contact card-dealer d-flex">
										<div className="card-image me-3">
											<div className="position-relative">
												<img src="/assets/imgs/dealer/dealer-listing/icon-12.svg" alt="Gastonsin" />
											</div>
										</div>
										<div className="card-info">
											<div className="card-title">
								...
								<div className="col-lg-4 col-sm-6">
									<div className="card-contact card-dealer d-flex">
										<div className="card-image me-3">
											<div className="position-relative">
												<img src="/assets/imgs/dealer/dealer-listing/icon-13.svg" alt="Gastonsin" />
											</div>
										</div>
										<div className="card-info">
											<div className="card-title">
								...
								<div className="col-lg-4 col-sm-6">
									<div className="card-contact card-dealer d-flex">
										...
										<div className="card-info">
											<div className="card-title">
												<Link className="title heading-6" href="/dealer-details">Gastonsin Tamale</Link>
												<p className="text-md-medium neutral-500">11 Clifton Down Road,
													Bristol, BS8 4AB</p>
											</div>
											<div className="card-method-contact2">
