                                                    ...
                                                    <div className="pt-20">
                                                        <div className="box-slider-range">
                                                            ...
                                                            <div className="box-value-price">
                                                                <span className="text-md-medium neutral-1000">{format(0, { decimals: 0 })}</span>
                                                                <span className="text-md-medium neutral-1000">{format(500, { decimals: 0 })}</span>
                                                            </div>
                                                        ...
                                                        <li>
                                                            <label className="cb-container">
                                                                ...
                                                                <span className="text-sm-medium">
                                                                    {" "}
                                                                    <img src="/assets/imgs/template/icons/star-yellow.svg" alt="Rambo" />
                                                                    <img src="/assets/imgs/template/icons/star-yellow.svg" alt="Rambo" />
                                                                    <img src="/assets/imgs/template/icons/star-yellow.svg" alt="Rambo" />
                                                                    <img src="/assets/imgs/template/icons/star-yellow.svg" alt="Rambo" />
                                                                    <img src="/assets/imgs/template/icons/star-yellow.svg" alt="Rambo" />
                                                        ...
                                                        <li>
                                                            <label className="cb-container">
                                                                ...
                                                                <span className="text-sm-medium">
                                                                    ...
                                                                    <img src="/assets/imgs/template/icons/star-yellow.svg" alt="Rambo" />
                                                                    <img src="/assets/imgs/template/icons/star-yellow.svg" alt="Rambo" />
                                                                    <img src="/assets/imgs/template/icons/star-grey.svg" alt="Rambo" />
                                                                </span>
                                                                <span className="checkmark" />
                                                            </label>
                                                        </li>
                                                    ...
                                                    <ul className="list-filter-checkbox">
                                                        ...
                                                        <li>
                                                            <label className="cb-container">
                                                                {" "}
                                                                <input type="checkbox" />
                                                                <span className="text-sm-medium">Labadi Beach Hotel</span>
                                                                <span className="checkmark" />{" "}
                                                            </label>
                                                            <span className="number-item">13</span>
                                                        </li>
                                                        <li>
                                                            <label className="cb-container">
                                                                {" "}
                                                                <input type="checkbox" />
                                                                <span className="text-sm-medium">Kempinski Gold Coast</span>
                                                                <span className="checkmark" />{" "}
                                                            </label>
                                                            <span className="number-item">23</span>
                                                        </li>
                                                        ...
                                                        <li>
                                                            <label className="cb-container">
                                                                {" "}
                                                                <input type="checkbox" />
                                                                <span className="text-sm-medium">Accra City View</span>
                                                                <span className="checkmark" />{" "}
                                                            </label>
                                                            <span className="number-item">76</span>
                                                        </li>
