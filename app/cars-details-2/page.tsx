                                            ...
                                            <div className="col-lg-7">
                                                <div className="position-relative rounded-12 overflow-hidden">
                                                    ...
                                                    <div className="box-button-abs">
                                                        <PhotoGalleryButton images={["/assets/imgs/cars-details/banner6.png", "/assets/imgs/cars-details/banner7.png", "/assets/imgs/cars-details/banner8.png", "/assets/imgs/cars-details/banner9.png", "/assets/imgs/cars-details/banner10.png"]} />
